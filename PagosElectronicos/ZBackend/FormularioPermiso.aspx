<%@ Page Title="" Language="C#" MasterPageFile="~/ZBackend/Backend.master" AutoEventWireup="true" CodeFile="FormularioPermiso.aspx.cs" Inherits="FormularioPermiso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">REGISTRO DE PERMISOS</h1>
    </section>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ...
                            ErrorMessage="Rellenar el campo de permiso"
                            ForeColor="Red">
